                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="container">
                            ...
                            <p class="banner_text">"Jelajahi pesona rumah adat Kalimantan yang memukau dengan ukiran
                                kayu yang indah dan desain unik. Terpesona oleh keanggunan rumah betang dan
                                hiasan-hiasan yang menceritakan sejarah suku-suku Dayak dan Banjar"</p>
                    ...
                    <div class="carousel-item">
                        <div class="container">
                            ...
                            <p class="banner_text">"Jelajahi pesona pakaian adat Kalimantan yang memikat dengan corak
                                dan hiasan yang indah. Dari kain tenun yang menakjubkan hingga motif tradisional yang
                                unik."</p>
                    ...
                    <div class="carousel-item">
                        <div class="container">
                            ...
                            <p class="banner_text">"Nikmati pesona tari tradisional Kalimantan yang memikat dengan
                                gerakan yang mempesona dan kostum yang indah. Saksikanlah pertunjukan yang memukau dan
                                jelajahi kebudayaan tari Kalimantan yang kaya dan menginspirasi."</p>
                    ...
                    <div class="carousel-item">
                        <div class="container">
                            ...
                            <p class="banner_text">"Selamat datang dalam perjalanan yang memukau ke dalam warisan
                                budaya Kalimantan melalui menu Benda Tradisional Kalimantan. Di sini, Anda akan
                                menemukan keunikan dan keindahan benda-benda tradisional Kalimantan"</p>
...
<div class="about_section layout_padding">
    <h1 class="game_taital"><img style="width: 50px" src="{{ asset('img/budaya.png') }}"> <span>Menu Budaya
            Kalimantan</span></h1>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    Dalam menu Rumah Adat Kalimantan, kami mengundang Anda untuk memasuki dunia yang penuh warna dan
                    keajaiban rumah-rumah adat Kalimantan. Melalui atap rumah tinggi, kolong yang terbuka, dan
                    hiasan-hiasan yang indah, Anda akan merasakan nuansa yang khas dari setiap suku di Kalimantan.
                    Rasakan sentuhan alami dari kayu-kayu yang menghiasi rumah betang dan desain yang menggambarkan
                    harmoni antara manusia dan alam. Di sini, kami mempersembahkan keindahan rumah adat Kalimantan
                    sebagai tempat suci yang menghubungkan manusia dengan leluhur dan alam semesta. Selamat menikmati
                    petualangan budaya yang luar biasa ini.
                </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    Dalam menu Pakaian Adat Kalimantan, Anda akan menemukan pesona dan keindahan pakaian adat yang
                    mencerminkan identitas budaya Kalimantan. Setiap pakaian adat memiliki keunikan tersendiri, dengan
                    desain dan motif yang memikat. Dari pakaian adat suku Dayak yang megah dan berwarna-warni hingga
                    keanggunan pakaian adat suku Banjar yang elegan, Anda akan terpesona oleh kerajinan tangan dan
                    keindahan tekstil yang memadukan tradisi dan keindahan modern. Jelajahi keanekaragaman pakaian adat
                    Kalimantan dan biarkan diri Anda terpesona oleh keindahan dan pesona budaya yang tak tertandingi.
                </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    Dalam menu Tari Tradisional Kalimantan, Anda akan diajak untuk menyaksikan keindahan dan keberagaman
                    tarian tradisional yang menghiasi budaya Kalimantan. Menari dengan lincah dan penuh semangat,
                    tari-tari seperti Tari Giring-giring, Tari Baksa Kembang, dan Tari Kancet Papatai akan mempesona
                    Anda dengan gerakan yang enerjik dan cerita yang terkandung di dalamnya. Mari bergabung dengan
                    pertunjukan tari yang memukau dan merasakan keajaiban budaya Kalimantan melalui pergerakan yang
                    elegan dan nuansa yang tak terlupakan.
                </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    Dalam menu Benda Tradisional Kalimantan, Anda akan terpesona oleh keragaman benda-benda tradisional
                    yang mencerminkan kebudayaan Kalimantan. Lihatlah kerajinan tangan yang indah seperti anyaman tikar,
                    ukiran kayu yang rumit, dan kerajinan perak yang memukau. Setiap benda tradisional memperlihatkan
                    keahlian tangan yang diwariskan dari generasi ke generasi, menggambarkan kekayaan budaya dan
                    keunikan suku-suku Kalimantan. Mari jelajahi dan menikmati keindahan serta makna dalam setiap benda
                    tradisional yang ada di Kalimantan.
                </p>

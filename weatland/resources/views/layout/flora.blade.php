                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="container">
                            ...
                            <p class="banner_text">"Jelajahi flora yang hidup di berbagai ekosistem, seperti hutan hujan
...
<div class="about_section layout_padding">
    <h1 class="game_taital"><img style="width: 50px" src="{{ asset('img/flora.png') }}"> <span>Flora Kalimantan
            :</span></h1>
    <div class="container">
        <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div>
                        <div class="read_bt mr-3"><a href="{{ route('readmore.flora', ['id' => $item->id]) }}">Baca
                                Lebih Lanjut</a></div>
                ...
                <div class="col-md-6 mt-5">
                    <div class="mt-2">
                        <div class="mt-2">
                            <img src="{{ url('storage/' . $item->image) }}" class="image_1"

...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Suara Fauna Kalimantan</title>
   ...
   <div class="header_section" style="background-image: url({{asset('img/banner-suara-fauna.png')}})">
   ...
   <!--header section end -->
      ...
      <div class="about_section layout_padding">
        <h1 class="game_taital"><img style="width: 50px" src="{{asset('img/voiceanimal.png')}}"> <span>Suara Fauna Kalimantan :</span></h1>
        <div class="container">
            <div class="row">
            ...
            @foreach ($items as $item)
                <div class="container text-center m-3">
                    <div class="row row-cols-4">
                        <div class="col"><img src="{{ url('storage/' . $item->image) }}" alt="s" height="70px">
                        </div>
                        <div class="col">

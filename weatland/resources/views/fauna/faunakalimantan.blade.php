...
<html lang="en">
   ...
   <!--header section end -->
      ...
      <div class="about_section layout_padding">
        <h1 class="game_taital"><img style="width: 50px" src="{{asset('img/fauna.png')}}"> <span>Fauna Kalimantan :</span></h1>
        <div class="container">
            <div class="row">
        ...
        <div class="container">
          <div class="row">
              ...
              <div>
                <div class="read_bt mr-3"><a href="{{ route('readmore.faunakalimantan', ['id' => $item->id]) }}">Baca Lebih Lanjut</a></div>

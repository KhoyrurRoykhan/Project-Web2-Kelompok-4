   ...
   <!--header section end -->
      ...
      <div class="game_section layout_padding">
         <div class="container">
            ...
            <p class="game_text">"Selamat datang di halaman beranda kami, di mana Anda dapat menjelajahi kekayaan flora, fauna, dan budaya yang memukau di Pulau Kalimantan!"</p>
                ...
                <div class="col-lg-3 col-sm-6">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="image_4" style="background-image: url({{asset('img/quis-img.png')}})">
                       ...
                       <p class="many_text">Ayo uji pengetahuan mu tentang flora, fauna, dan budaya di pulau Kalimantan</p>
                    </div>

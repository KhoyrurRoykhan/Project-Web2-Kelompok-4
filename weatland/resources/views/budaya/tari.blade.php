...
<html lang="en">
   ...
   <!--header section end -->
      ...
      <div class="about_section layout_padding">
        <h1 class="game_taital"><img style="width: 50px" src="{{asset('img/pakaian.png  ')}}"> <span>Tari Tradisional Kalimantan :</span></h1>
        <div class="container">
            <div class="row">
        ...
        <div class="container">
          <div class="row">
              ...
              <div>
                <div class="read_bt mr-3"><a href="{{ route('readmore.tari', ['id' => $item->id]) }}">Baca Lebih Lanjut</a></div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('tari.update', $item->id) }}" method="post"

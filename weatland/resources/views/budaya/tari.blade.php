                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="container">
                            ...
                            <p class="banner_text">"Saksikanlah harmoni gerakan dan irama musik dalam pertunjukan tari
                                tradisional Kalimantan, yang menceritakan cerita-cerita legendaris dan menghormati
                                hubungan manusia dengan alam."</p>
...
<div class="about_section layout_padding">
    <h1 class="game_taital"><img style="width: 50px" src="{{ asset('img/pakaian.png  ') }}"> <span>Tari Tradisional
            Kalimantan :</span></h1>
    <div class="container">
        <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div>
                        <div class="read_bt mr-3"><a href="{{ route('readmore.tari', ['id' => $item->id]) }}">Baca
                                Lebih Lanjut</a></div>

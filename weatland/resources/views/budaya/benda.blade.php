...
<html lang="en">
   ...
   <div class="header_section" style="background-image: url({{asset('img/banner-benda.png')}})">
   ...
   <!--header section end -->
      ...
      <div class="about_section layout_padding">
        <h1 class="game_taital"><img style="width: 50px" src="{{asset('img/pakaian.png  ')}}"> <span>Benda Tradisional Kalimantan :</span></h1>
        <div class="container">
            <div class="row">
        ...
        <div class="container">
          <div class="row">
              ...
              <div>
                <div class="read_bt mr-3"><a href="{{ route('readmore.benda', ['id' => $item->id]) }}">Baca Lebih Lanjut</a></div>

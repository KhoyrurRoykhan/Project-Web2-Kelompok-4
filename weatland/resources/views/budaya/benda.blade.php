                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="container">
                            ...
                            <p class="banner_text">"Jelajahi kekayaan budaya Kalimantan melalui koleksi benda adat kami,
                                termasuk barang-barang bersejarah seperti piala ukir, tombak perang, dan lukisan
                                tradisional, yang menggambarkan nilai-nilai dan identitas suku Dayak."</p>
...
<div class="about_section layout_padding">
    <h1 class="game_taital"><img style="width: 50px" src="{{ asset('img/pakaian.png  ') }}"> <span>Benda Tradisional
            Kalimantan :</span></h1>
    <div class="container">
        <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div>
                        <div class="read_bt mr-3"><a href="{{ route('readmore.benda', ['id' => $item->id]) }}">Baca
                                Lebih Lanjut</a></div>

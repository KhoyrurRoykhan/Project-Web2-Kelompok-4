...
<div class="about_section layout_padding">
    <h1 class="game_taital"><img style="width: 50px" src="{{ asset('img/pakaian.png  ') }}"> <span>Pakaian Adat
            Kalimantan :</span></h1>
    <div class="container">
        <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div>
                        <div class="read_bt mr-3"><a href="{{ route('readmore.pakaian', ['id' => $item->id]) }}">Baca
                                Lebih Lanjut</a></div>

...
<body>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <div class="container">
                                ...
                                <p class="banner_text">"Temukan dan jelajahi spesies-spesies fauna yang menarik dari
                                    seluruh dunia. Dapatkan informasi tentang habitat, karakteristik, dan kehidupan
                                    mereka."</p>
                                <div class="book_bt"><a href="{{ route('sesi.index') }}">Masuk Sekarang</a></div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="container">
                                <h4 class="banner_taital">Welcome to</h4>
                                <h1 class="banner_taital_1">B o r n e o W e t l a n d</h1>
                                <p class="banner_text">"Temukan dan jelajahi kekayaan warisan budaya dari berbagai
                                    negara dan komunitas. Pelajari tentang tradisi, seni, adat istiadat, dan perayaan
                                    yang memperkaya dunia budaya."</p>
                                <div class="book_bt"><a href="{{ route('sesi.index') }}">Masuk Sekarang</a></div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="container">
                                ...
                                <p class="banner_text">"Jangan lewatkan kesempatan untuk menguji pengetahuanmu tentang
                                    flora, fauna, dan budaya melalui kuis ini. Bersiaplah untuk mengeksplorasi dan
                                    belajar dengan penuh semangat."</p>
                                <div class="book_bt"><a href="{{ route('sesi.index') }}">Masuk Sekarang</a></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="play_section layout_padding mt-5">
        <div class="container">
            ...
            <p class="play_text">Selamat datang di website kami yang menyajikan fitur menarik tentang flora, fauna, dan
                budaya! kami juga menghadirkan fitur Kuis yang menguji pengetahuan Anda tentang flora, fauna, dan
                keanekaragaman hayati. Bukti kan keahlian Anda dalam menjawab pertanyaan menarik dan menantang, dan
                jadilah ahli di bidang ini!</p>
            <div class="game_section_2 layout_padding">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <div class="container">
                        ...
                        <div class="image_7"><img style="width:130px;" src="{{ asset('img/voiceanimal.png') }}">
                        </div>
                        <h4 class="jone_text">Voice Fauna</h4>
                        <p class="ipsum_text"> Anda dapat mendengarkan suara-suara menarik dari fauna yang hidup di
                            pulau Kalimantan. Nikmati pengalaman audio yang memukau dan mendekatkan Anda dengan
                            keindahan alam dan keberagaman satwa-satwa Kalimantan. Mari jelajahi dunia suara fauna
                            Kalimantan!</p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="container">
                            ...
                            <p class="ipsum_text">Anda dapat menjelajahi keunikan dan keindahan benda-benda tradisional
                                ...
                                keberagaman seni dan kerajinan yang ada di pulau ini. Saksikanlah pesona benda-benda
                                khas Kalimantan!</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="">
                            <div class="map_main">
                                <div class="map-responsive">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8168627.043347212!2d108.75492143318564!3d1.4232561312629166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3200a51b0ce8057b%3A0xf81f7b0a97d0b88a!2sBorneo!5e0!3m2!1sen!2sid!4v1686618567048!5m2!1sen!2sid"
                                        width="800" height="400" style="border:0;" allowfullscreen=""
